...
class TestNexentaDriver ( cinder.test.TestCase ) :
    ...
    def test_create_export ( self ) :
        ...
        self.assertEquals ( retval , { 'provider_location':'%s:%s,1 %s%s' % ( FLAGS.nexenta_host , FLAGS.nexenta_iscsi_target_portal_port , FLAGS.nexenta_target_prefix , self.TEST_VOLUME_NAME ) } )
    def __get_test ( i ) :
