...
def read_args():
    ...
    parser.add_argument('-model_prefix', type=str, default='openstack_spm_10000_per_line')
    parser.add_argument('-vocab_size', type=int, default=10000)
    parser.add_argument('-character_coverage', type=int, default=1.0)
    parser.add_argument('-user_defined_symbols', type=list, default=['<pad>', '<added_code>', '<deleted_code>'])
