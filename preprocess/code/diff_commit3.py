...
from lang_processors4.clean_comment import remove_c_com_and_doc
from lang_processors4.py_tokenizer2 import py_tokenize
from lang_processors4.cpp_processor import CppProcessor
from lang_processors4.java_processor import JavaProcessor
    ...
    for repo_name in repo_list:  
        ...
        for i, hexsha in enumerate(id_list):
            ...
            try:
                ...
                pipe_process(repo, commit, hexsha, params, commit_dict, type='normal')
            except (IndexError, BadName):   
                pipe_process(repo, commit, hexsha, params, commit_dict, type='first')
