...
from code_transformer2 import CodeChangeTransformer
...
class ModelCCT(Model):
    ...
    def fit(self, train_loader, valid_loader, optimizer, criterion, earlystopping):
        ...
        for epoch in range(self.params['epochs']):
            ...
            self.model.train()
            for features, lines_mask, labels in tqdm(train_loader):
                ...
                optimizer.zero_grad()
                outputs = self.model([features, lines_mask])
            ...
            self.model.eval()
            with torch.no_grad():
                for val_features, val_lines_mask, val_labels in valid_loader:
                    ...
                    val_outputs = self.model([val_features, val_lines_mask])
